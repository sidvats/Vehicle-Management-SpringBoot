...
@ControllerAdvice
public class VMSException extends ResponseEntityExceptionHandler {

	@ExceptionHandler(VehicleNotFoundException.class)
	public ResponseEntity<ErrorDetails> handleException(VehicleNotFoundException exception, WebRequest request) {
